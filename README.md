...
This library does not manage Solr schemas. That boundary is intentional.

Setting up a collection — deciding which fields exist, what types they are, whether you
want a managed schema or schema-less mode — is the responsibility of the Solr administrator
(or your deployment pipeline). This library only cares about indexing documents and running
queries once a collection already exists.
